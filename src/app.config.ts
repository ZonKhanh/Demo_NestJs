...
export const APP = {
  ...
  FE_NAME: "QUICKSIGN",
  FE_URL: "http://sign.demo.zinisoft.net",
  STATIC_URL: "http://sign-api.demo.zinisoft.net",
};
...
export const CROSS_DOMAIN = {
  allowedOrigins: [
    ...
    "http://localhost:5173",
    "http://localhost:3000",
    "http://sign.demo.zinisoft.net",
    "http://sign-api.demo.zinisoft.net",
  ],
...
export const MONGO_DB = {
  uri: argv.db_uri || `mongodb://127.0.0.1:27017/quicksign`,
};
...
export const AUTH = {
  expiresIn: argv.auth_expires_in || 999999999999,
  data: argv.auth_data || { user: "root" },
  jwtSecret: argv.auth_key || "aivobot",
